function initialize() {
    ...
    // Multiple Markers
    var markers = [
        ['Level 3, 5 Nelson Street, Auckland CBD, Auckland 1010', -36.846231, 174.760343],
        ['1 Barry Hogan Place, Riccarton, Christchurch 8041', -43.539769, 172.599843],
        ['Level 3, 86 Victoria Street, Wellington 6011', -41.288863, 174.775978]
    ];
                        
    // Info Window Content
    var infoWindowContent = [
        ['<div class="info_content text-center">' +
        '<h3>Voyager Auckland Office</h3>' +
        '<p>Level 3, 5 Nelson Street, Auckland CBD, Auckland 1010</p>'+'</div>'],
        ['<div class="info_content text-center">' +
        '<h3>Voyager Christchurch Office</h3>' +
        '<p>1 Barry Hogan Place, Riccarton, Christchurch 8041</p>' +
        '</div>'],
        ['<div class="info_content text-center">' +
        '<h3>Voyager Wellington Office</h3>' +
        '<p>Level 3, 86 Victoria Street, Wellington 6011</p>' +
        '</div>']
    ];
